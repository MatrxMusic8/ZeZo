    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
                f"ʜᴇʏ {message.from_user.mention()},\nᴛʜɪs ɪs [{bn}](t.me/{lel}) ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ ᴀᴄᴄᴏᴜɴᴛ.\n\nᴅᴏɴ'ᴛ ᴛʀʏ ᴛᴏ sᴘᴀᴍ ʜᴇʀᴇ ᴇʟsᴇ ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ ꜰᴜ*ᴋᴇᴅ ʙʏ [𝑺𝑼𝑶𝑹𝑪𝑬 𝑩𝑬𝑴𝑩𝑶](t.me/SourseZezoMusic).\n",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        " 🦦 ¦ جـروب الدعم ", url="https://t.me/E_s_l_a_m_Zelzal"
                    )
                ],[ 
                    InlineKeyboardButton(
                        " ☢️ ¦قناة البوت ", url=f"https://t.me/SourseZezoMusic"
                    )]
            ]
        ),
